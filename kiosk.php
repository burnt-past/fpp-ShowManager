...
<svg class="bg facade" viewBox="0 0 1200 520" preserveAspectRatio="xMidYMax meet" aria-hidden="true"><defs><mask id="mfac"><rect x="0" y="0" width="1200" height="520" fill="black"/><rect x="90" y="384" width="345" height="136" fill="#fff"/><rect x="915" y="384" width="200" height="136" fill="#fff"/><rect x="420" y="250" width="360" height="270" fill="#fff"/><path d="M420 258 L420 214 Q425 150 505 132 Q600 104 695 132 Q775 150 780 214 L780 258 Z" fill="#fff"/><rect x="778" y="182" width="140" height="338" fill="#fff"/><path d="M776 188 A72 78 0 0 1 920 188 Z" fill="#fff"/><rect x="594" y="66" width="12" height="70" fill="#fff"/><rect x="577" y="88" width="46" height="12" fill="#fff"/><rect x="843" y="70" width="10" height="52" fill="#fff"/><rect x="829" y="88" width="38" height="10" fill="#fff"/><path d="M556 520 L556 398 A44 44 0 0 1 644 398 L644 520 Z" fill="#000"/><path d="M540 244 L540 214 A16 16 0 0 1 572 214 L572 244 Z" fill="#000"/><path d="M628 244 L628 214 A16 16 0 0 1 660 214 L660 244 Z" fill="#000"/><path d="M818 306 L818 258 A30 30 0 0 1 878 258 L878 306 Z" fill="#000"/><g fill="#000"><path d="M112 520 L112 474 A28 28 0 0 1 168 474 L168 520 Z"/><path d="M188 520 L188 474 A28 28 0 0 1 244 474 L244 520 Z"/><path d="M264 520 L264 474 A28 28 0 0 1 320 474 L320 520 Z"/><path d="M340 520 L340 474 A28 28 0 0 1 396 474 L396 520 Z"/><path d="M940 520 L940 474 A28 28 0 0 1 996 474 L996 520 Z"/><path d="M1016 520 L1016 474 A28 28 0 0 1 1072 474 L1072 520 Z"/></g></mask></defs><rect x="0" y="0" width="1200" height="520" fill="#0f2230" mask="url(#mfac)"/><rect class="glow" x="0" y="0" width="1200" height="520" opacity=".22" mask="url(#mfac)"/></svg>
...
(async function(){
  ...
  const bloomEl=document.querySelector('.bg.bloom');
  ...
  function updateTheme(src){
    ...
    if(bloomEl)bloomEl.style.opacity='0';   // the show owns the palette now
  ...
  setInterval(()=>{
    if(liveLook&&Date.now()-lastLit>5000){
      ...
      if(bloomEl)bloomEl.style.opacity='';
